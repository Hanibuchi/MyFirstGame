...
public class StatisticsManager : MonoBehaviour
{
    ...
    public void Save()
    {
        EditFile.SaveObjectAsCompressedJson(StatisticsPath, m_statisticsData);
    }
    public void Load()
    {
        StatisticsData data = EditFile.LoadCompressedJsonAsObject<StatisticsData>(StatisticsPath);
        if (data != null)
